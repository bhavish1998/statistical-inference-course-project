---
title: Exponential distribution in R and compare it with the Central
  Limit Theorem and Investigate it
...
## Overview
The objective of this data analysis is to investigate the exponential distribution
and compare it to the Central Limit Theorem. In this analysis, the lambda will 
be set to 0.2 for all of the simulations taken into consideration. This analysis or 
investigation will compare the distribution of averages of 40 exponentials over 1000 
simulations.
